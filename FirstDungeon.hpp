...
**				a prisoner. 
*********************************************************************/
#ifndef FIRSTDUNGEON_HPP
#define FIRSTDUNGEON_HPP
#include "Space.hpp"

class FirstDungeon : public Space {
private:
	int goblin;
